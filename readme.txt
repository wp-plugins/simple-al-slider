...
You can see demo at <a href="http://al-plugins.biz/simple-al-slider-box/">Simple AL Slider Live Demo</a>
Simple AL Slider is enough flexible and very easy to setup. You can add images and texts to any of your slide. It very helpful to show all benefits of your site for example.<span style="color:red;">New Effects added.</span>
...
*   Two direction for moving slides.
*   Responsive design.


== Installation ==

1. Upload `simple_al_slider` folder to the `/wp-content/plugins/` directory
...
3.I install this plugin but it is displayed incorrect?
