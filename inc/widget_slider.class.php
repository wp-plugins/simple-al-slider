...
class Slider_Widget extends \WP_Widget {
  ...
  */
  function __construct() {
    parent::__construct(
      'simple_al_slider_widget', // Base ID
      __( 'Simple AL Slider', 'text_domain' ), // Name
      array( 'description' => __( 'Adding of Simple AL Slider', 'text_domain' ), ) // Args
    );
  }
  ...
  */
  public function widget( $args, $instance ) {
    ...
    echo do_shortcode("[simple_al_slider id=".$instance['slider_id']."]");
  ...
  */
  public function form( $instance ) {
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['slider_id'] = $new_instance['slider_id'];//intval( $new_instance['slider_id'], 10 );
